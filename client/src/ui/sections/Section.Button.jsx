 ...
 * @param {function} func - Función que actualiza los datos después de ser editados en el modal.
 * @param {ReactNode} children - Elementos adicionales que pueden incluirse debajo de la sección.
 */
const SectionWButton = ({ title, css, data, setData, func, children }) => {
